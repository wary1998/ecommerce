                            ...
                            <div class="sumary-product single-layout">
                                <div class="media">
                                    <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                                        <li><img src="admin/upload/<?php echo $pro['pdt_img']; ?>" alt="" width="500" height="500"></li>
                                ...
                                <div class="product-attribute">
                                    ...
                                    <div class="rating">
                                        ...
                                        <b class="category">By: <?php echo $pro['ctg_name']; ?></b>
                                    </div>
                                    <span class="sku">Sku: #<?php echo $pro['pdt_id']; ?></span>
                                    <p class="excerpt"><?php echo $pro['pdt_des']; ?></p>
                                    <div class="price">
                                        <ins><span class="price-amount"><span class="currencySymbol">TK.</span><?php echo $pro['pdt_price']; ?></span></ins>
                                                                           </div>
                                ...
                                <div class="action-form">
                                    <div class="quantity-box">
                                        <form action="" method="POST">
                                            ...
                                            <div class="qty-input">
                                            <input type="number" name="quantity"  data-max_value="20" data-min_value="1" data-step="1" value="<?php  
                                            if(isset($_POST['update_total'])){
                                                $quantity = $_POST['quantity'];
                                                echo $quantity;
                                            }else{
                                            ...
                                            <input class="btn btn-success" type="submit" value="Update Total" name="update_total">
                                        </form>
                                    </div>
